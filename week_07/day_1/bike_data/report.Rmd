...
nyc_bikes %>% 
  ...
  addMarkers(lat = ~ start_lat,
             lng = ~ start_long)
```
All of the rentals in our dataset which start at the peak times of 8am and 6pm start close to Jersey City and Hoboken.
...
Upon confirmation of this pattern with additional data, Citi Bikes can use this information to ensure that they have bikes available in the right places. They might also consider advertising or testing new distribution in under-utilised areas such as Manhattan.
