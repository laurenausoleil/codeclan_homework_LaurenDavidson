...
H0: π population(aware) = 0.4
Ha: π population(aware) > 0.4
...
Thoughts: with a null hypothesis, we make the most conservative estimate. Therefors in this instance we should assume drift and test to prove no drift? I do not know how to formulate a null hypothesis which assumes drift though. Perhaps we could raise the significance level and investigate further if we get a p value of less than 0.1. 
