...
Conclusion
With a p value of 0.026, we can reject the null hypothesis and infer that omnivores have a significantly higher sleep total than herbivores.
...
```{r}
msleep %>% 
  mutate(is_domesicated = case_when())
```
