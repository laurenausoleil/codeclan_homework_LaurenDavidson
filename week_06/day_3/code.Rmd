...
```
Fairly normal, right skewed, steeper curve on lower prices than for high, suggesting some outliers in the high prices.
...
For each of these samples, I bootstrapped 1000 samples and calculated a confidence interval with a confidence level of 95%.
Each CI tells me that in 95% of the samples I draw from my population, my parameter will lie on this interval.
i.e. the confidence interval I have calculated from this one sample, will contain the point estimate for 95% of the samples I could have drawn for the population. By extension, that it is a pretty good guess that the population parameter will fall on this interval.
...
No. I could only know whther my CI was correct for the population by comparing it to the population data. I would have a high confidence in it though, assuming that I didn't have any sample bias
